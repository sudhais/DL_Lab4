...
Original file is located at
    https://colab.research.google.com/drive/1_PSMnc7cOW54el61c46zNN2SCXP2iVYH
...
!unzip '/content/drive/MyDrive/DL/lab_5.zip'  #Change the zip file name as needed

#!pip list
import sys
sys.path.append('/content/lab_5')
import yolo_utils
...
out_scores, out_boxes, out_classes = predict_(sess, "car2.JPG")

out_scores, out_boxes, out_classes = predict_(sess, "DSC_1643_resized.jpg")

out_scores, out_boxes, out_classes = predict_(sess, "giraffe_resized.jpg")
